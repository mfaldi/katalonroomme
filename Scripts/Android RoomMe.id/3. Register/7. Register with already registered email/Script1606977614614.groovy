...
Mobile.setText(findTestObject('Android RoomMe.id/Sign Up Page/Textfield Emails'), 'faldidev10@getnada.com', 0)
...
not_run: def toast = driver.findElementByXPath('//android.widget.Toast[@text=\'Email already registered\']')
