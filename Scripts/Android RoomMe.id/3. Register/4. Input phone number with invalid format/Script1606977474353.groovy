...
Mobile.setText(findTestObject('Android RoomMe.id/Sign Up Page/Textfield Phone Number'), '12345678', 0)
...
Mobile.clearText(findTestObject('Android RoomMe.id/Sign Up Page/Textfield Phone Number'), 0)
