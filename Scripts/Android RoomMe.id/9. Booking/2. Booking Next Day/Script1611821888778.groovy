...
WebUI.callTestCase(findTestCase('Android RoomMe.id/7. Search For Unit/2. Search unit by Name and Next Day Check-in'), [:], 
...
Mobile.tap(findTestObject('Android RoomMe.id/Payment Term Option Page/RadioButton Deposit Only'), 0)
