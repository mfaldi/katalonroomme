...
WebUI.verifyElementVisible(findTestObject('Web RoomMe.id/RoomMe.id Homepage/Button Contact Us'))

WebUI.click(findTestObject('Web RoomMe.id/RoomMe.id Homepage/Button Contact Us'))
