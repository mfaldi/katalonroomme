...
WebUI.sendKeys(findTestObject('Web RoomMe.id/RoomMe.id Landlord Page/Textfield Phone Number'), '1234567890')

WebUI.sendKeys(findTestObject('Web RoomMe.id/RoomMe.id Landlord Page/Textfield Phone Number'), Keys.chord(Keys.CONTROL, 
        'a', Keys.BACK_SPACE))

WebUI.sendKeys(findTestObject('Web RoomMe.id/RoomMe.id Landlord Page/Textfield Phone Number'), '0812345678901')
