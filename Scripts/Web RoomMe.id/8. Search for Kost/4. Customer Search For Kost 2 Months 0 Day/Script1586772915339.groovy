...
WebUI.click(findTestObject('Web RoomMe.id/Search Kost Menu/Button 2 Months'))

WebUI.click(findTestObject('Object Repository/Web RoomMe.id/Search Kost Menu/Button Additional'))

not_run: WebUI.click(findTestObject('Web RoomMe.id/Search Kost Menu/Button 2 Days'))
