...
not_run: Mobile.verifyElementText(findTestObject('Android RoomMe.id/Sign Up Page/Error Message/Text Please input the password'), 
    'Please input the password')

not_run: Mobile.setEncryptedText(findTestObject('Android RoomMe.id/Sign Up Page/Textfield Confirm Password'), 'aeHFOx8jV/A=', 
    0)

Mobile.verifyElementText(findTestObject('Android RoomMe.id/Sign Up Page/Error Message/Text Password is incorrect'), 'Password is incorrect')
