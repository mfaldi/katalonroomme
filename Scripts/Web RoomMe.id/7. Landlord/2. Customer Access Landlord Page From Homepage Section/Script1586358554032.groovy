...
WebUI.waitForElementVisible(findTestObject('Web RoomMe.id/RoomMe.id Homepage/Button Get Started'), 30)

WebUI.click(findTestObject('Web RoomMe.id/RoomMe.id Homepage/Button Get Started'))
