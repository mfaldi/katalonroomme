...
WebUI.waitForElementVisible(findTestObject('Web RoomMe.id/RoomMe.id Header/Button Are You Landlord'), 30)

WebUI.click(findTestObject('Web RoomMe.id/RoomMe.id Header/Button Are You Landlord'))
