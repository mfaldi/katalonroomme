...
WebUI.click(findTestObject('Web RoomMe.id/User Menu/Button My Booking'))

WebUI.verifyElementVisible(findTestObject('Web RoomMe.id/RoomMe.id My Booking Page/Text My Bookings'))
